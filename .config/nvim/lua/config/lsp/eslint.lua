...
---@class EslintExperimentalSettings
        ...
        if root_dir then
            ...
            for _, file in ipairs(flat_config_files) do
                ...
                if #filtered_files > 0 then
                    local experimental = config.settings.experimental or {}
                    ---@cast experimental EslintExperimentalSettings
                    experimental.useFlatConfig = true
                    config.settings.experimental = experimental
                    break
                end
            end
        end
